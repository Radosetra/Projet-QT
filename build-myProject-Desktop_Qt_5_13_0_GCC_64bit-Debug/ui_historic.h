...
public:
    ...
    void setupUi(QDialog *historic)
    {
        ...
        vue->setMinimumSize(QSize(600, 600));
        vue->setMaximumSize(QSize(600, 700));
...
"}"));
    ...
    {
        historic->setWindowTitle(QCoreApplication::translate("historic", "Historique", nullptr));
        visionner_btn->setText(QCoreApplication::translate("historic", "Visionner", nullptr));
        pushButton->setText(QCoreApplication::translate("historic", "Retour", nullptr));
    } // retranslateUi
