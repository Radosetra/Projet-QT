...
#include "../../../QT_Project/myProject/finance.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_finance_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_finance_t qt_meta_stringdata_finance = {
    {
QT_MOC_LITERAL(0, 0, 7), // "finance"
QT_MOC_LITERAL(1, 8, 17), // "on_retour_clicked"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 15) // "on_view_clicked"

    },
    "finance\0on_retour_clicked\0\0on_view_clicked"
};
...
void finance::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<finance *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject finance::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_finance.data,
    qt_meta_data_finance,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *finance::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_finance.stringdata0))
